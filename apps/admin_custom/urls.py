...
urlpatterns = [
    ...
    # Withdrawal requests — convenience redirect to payments app page
    path('withdrawals/',                                            views.withdrawal_requests_redirect, name='withdrawal_requests'),
